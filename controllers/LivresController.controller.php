...
class LivresController{
    ...
    //Supprimer un livre avec son image dans le repertoire sur base de l'ID renseigner
    ...
    //Validation d'ajout livre dans la base de données
    ...
    //Fonction de vérification d'une image et la placer dans le repertoire des images
