...
class LivreManager extends Model{
    ...
    //Obtenir un seul livre à partir de l'id du livre dans l'URL
    ...
    //Fonction d'ajout d'un livre dans la base de données avec paramètre
    public function ajoutLivreBd($titre,$nbPages,$image){
        ...
        if($resultat > 0){
            ...
            //Ajout d'un livre dans un tableau susmentionné
            $this->ajoutLivre($livre);
        }        
    }

    //Supprimer un livre à partir d'un ID
    public function suppressionLivreBD($id){
        ...
        if($resultat > 0){
            ...
            //Enlèver le livre supprimer dans le tableau
            unset($livre);
        }
    }
